...
import 'package:food_e_commerce/utils/app_constants.dart';
        ...
        slivers: [
          SliverAppBar(
            ...
            bottom: PreferredSize(
              ...
              child: Container(
                //margin: EdgeInsets.only(left: Dimensions.width20, right: Dimensions.width20),                color: Colors.white,
                child: Center(child: BigText(size: Dimensions.font26, text: product.name)),
                width: double.maxFinite, //take the complete space in width
